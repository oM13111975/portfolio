    ...
    <div className="bg-light-bg dark:bg-dark-bg min-h-screen transition-colors duration-300">
      ...
      <div className="hidden lg:block fixed bottom-0 left-12 w-10">
        <ul className="flex flex-col items-center space-y-6 after:content-[''] after:block after:w-px after:h-24 after:bg-textLight-secondary dark:after:bg-text-secondary after:mt-6">
          <li>
            <a href="https://github.com/oM13111975" className="text-textLight-secondary dark:text-text-secondary hover:text-accent-primary dark:hover:text-accent-primaryDark hover:-translate-y-1 transition-all block">
          ...
          <li>
            <a href="https://linkedin.com/in/om-s-899a68344" className="text-textLight-secondary dark:text-text-secondary hover:text-accent-primary dark:hover:text-accent-primaryDark hover:-translate-y-1 transition-all block">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
